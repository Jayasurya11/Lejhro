...
const TermsOfUseBody = () => {
  return (
    <div className="top-data-analysis">
      <div className="data-analysis">
        <h6>Welcome to Lejhro Technology!</h6>

        <p>
          These terms and conditions outline the rules and regulations for the
          use of Lejhro Technology Pvt. Ltd.'s Website, located at
          www.lejhro.com
        </p>
        <p>
          By accessing this website we assume you accept these terms and
          conditions. Do not continue to use Lejhro Technology if you do not
        ...
        <h6>Cookies</h6>
        <p>
          We employ the use of cookies. By accessing Lejhro Technology, you
          agreed to use cookies in agreement with the Lejhro Technology Pvt.
        ...
        <h6>License</h6>
        <p>
          Unless otherwise stated, Lejhro Technology Pvt. Ltd. and/or its
          licensors own the intellectual property rights for all material on
          Lejhro Technology. All intellectual property rights are reserved. You
          may access this from Lejhro Technology for your own personal use
          subjected to restrictions set in these terms and conditions.
        </p>
        <p>You must not:</p>
        <ul>
          <li>Republish material from Lejhro Technology</li>
          <li>Sell, rent or sub-license material from Lejhro Technology</li>
          <li>Reproduce, duplicate or copy material from Lejhro Technology</li>
          <li>Redistribute content from Lejhro Technology</li>
        </ul>
        ...
        <p>
          ...
          Lejhro Technology Pvt. Ltd. does not filter, edit, publish or review
          Comments prior to their presence on the website. Comments do not
          reflect the views and opinions of Lejhro Technology Pvt. Ltd.,its
          ...
          by applicable laws, Lejhro Technology Pvt. Ltd. shall not be liable
        ...
        <p>
          Lejhro Technology Pvt. Ltd. reserves the right to monitor all Comments
        ...
        <p>
          You hereby grant Lejhro Technology Pvt. Ltd. a non-exclusive license
        ...
        <p>
          ...
          the hyperlink compensates the absence of Lejhro Technology Pvt. Ltd.;
        ...
        <p>
          ...
          sending an e-mail to Lejhro Technology Pvt. Ltd.. Please include your
        ...
        <p>
          No use of Lejhro Technology Pvt. Ltd.'s logo or other artwork will be
        ...
        <h6>Refund Policy</h6>
        <p>
          For our consulting services payment and refund has to be discussed
          with our executives at time of signing the contract
        </p>
        <p>
          For our Bootcamp Program, there is no refund once the payment is
          processed successfully.
        </p>
        <h6>Shipping Charges</h6>
        <p>
          Our product and services are deliver with soft copy in online mode.
          There is no physical delivery. We don't charge any shipping charges.
        </p>
      </div>
    </div>
  );
