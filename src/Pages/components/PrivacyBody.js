  ...
  return (
    <div className="top-data-analysis">
      <div className="data-analysis">
        <p>
          At Lejhro Technology, accessible from www.lejhro.com, one of our main
          priorities is the privacy of our visitors. This Privacy Policy
          document contains types of information that is collected and recorded
          by Lejhro Technology and how we use it.
        </p>
        <p>
        ...
        <p>
          ...
          shared and/or collect in Lejhro Technology. This policy does not apply
        ...
        <h6>Log Files</h6>
        <p>
          Lejhro Technology follows a standard procedure of using log files.
        ...
        <p>
          ...
          advertising partners of Lejhro Technology.
        </p>
        <p>
          Third-party ad servers or ad networks uses technologies like cookies,
          JavaScript, or Web Beacons that are used in their respective
          advertisements and links that appear on Lejhro Technology, which are
        ...
        <p>
          Note that Lejhro Technology has no access to or control over these
          cookies that are used by third-party advertisers.
        </p>

        <h6>Third Party Privacy Policies</h6>
        <p>
          Lejhro Technology's Privacy Policy does not apply to other advertisers
        ...
        <p>
          Lejhro Technology does not knowingly collect any Personal Identifiable
